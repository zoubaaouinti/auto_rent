...
// Modèle pour les détails de location
class RentalDetails {
  final String marque;
  final String modele;
  final String annee;
  ...
  factory RentalDetails.fromJson(Map<String, dynamic> json) {
    return RentalDetails(
      ...
      dateDebut: json['dateDebut'] as DateTime,
      dateFin: json['dateFin'] as DateTime,
      duree: json['duree'] as int,
      lieuPrise: json['lieuPrise'] as String,
      lieuRestitution: json['lieuRestitution'] as String,
      nomChauffeur: json['nomChauffeur'] as String,
      caution: (json['caution'] as num).toDouble(),
      optionsIncluses: List<String>.from(json['optionsIncluses'] as List),
